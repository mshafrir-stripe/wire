...
// I cannot get the extension to work in projects included via `includeBuild` within
// `build-support`.
...
class WireBuildPlugin : Plugin<Project> {
  ...
  override fun apply(target: Project) {
    ...
    if (target.name == "wire-gradle-plugin") {
      target.publishPluginsIfRelease()
    }
  }

  private fun Project.publishPluginsIfRelease() {
